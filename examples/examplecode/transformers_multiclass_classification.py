...
from small_text.training.early_stopping import DefaultEarlyStoppingHandler
...
def main(num_iterations=10):
    ...
    active_learner.classifier.fit(train, early_stopping=DefaultEarlyStoppingHandler('train_acc', threshold=0.8))
