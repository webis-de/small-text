...
*Every little bit of effort is appreciated and we welcome everyone who is willing to learn.*
...
You are responsible to guarantee that the code is a) either written by yourself,
...
5. Create a pull request. (You can also create the pull request earlier if you mark it as "work in progress").
