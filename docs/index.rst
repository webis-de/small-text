...
- Examples: `Notebooks <https://github.com/webis-de/small-text/tree/v1.4.1/examples/notebooks>`_ | `Code Examples <https://github.com/webis-de/small-text/tree/v1.4.1/examples/examplecode>`_
