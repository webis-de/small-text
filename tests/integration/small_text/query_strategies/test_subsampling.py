...
class AnchorSubsamplingTest(unittest.TestCase, SamplingStrategiesTests):
    ...
    def test_initialize_index_default_hnsw_kwargs(self, num_samples=100):
        ...
        index = AnchorSubsampling.initialize_index(embeddings, indices_unlabeled, hnsw_kwargs)
    ...
    def test_str(self):
        ...
        self.assertEqual(
            ...
            'k=5, hnsw_kwargs={}, embed_kwargs={}, normalize=True, batch_size=32)',
            str(query_strategy))
    ...
    def test_str_non_default(self):
        ...
        self.assertEqual(
            'AnchorSubsampling(base_query_strategy=LeastConfidence(), num_anchors=10, ' +
            'k=40, hnsw_kwargs={}, embed_kwargs={\'a\': \'b\'}, normalize=False, batch_size=32)',
            str(query_strategy))
