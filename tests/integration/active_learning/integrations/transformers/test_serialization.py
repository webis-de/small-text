...
from active_learning.integrations.transformers import TransformersDataset
...
try:
    ...
    from active_learning.integrations.transformers.classifiers import TransformerBasedClassificationFactory
